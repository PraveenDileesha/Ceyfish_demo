    ...
    <div className="relative h-screen w-full min-w-[320px] overflow-hidden">
      ...
      <div className="relative z-10 h-full w-full min-w-[320px] flex flex-col overflow-hidden">
        ...
        <header className="relative z-10 w-full flex p-4 landscape-mobile:p-2">
          <img src={logo} alt="Logo" className="object-contain w-15 md:w-20 landscape-mobile:w-12 transition-all duration-300 ease-in-out" />
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] landscape-mobile:grid-cols-[1.5fr_1fr] gap-2 md:gap-4 lg:gap-8 landscape-mobile:gap-3 text-white w-full space-y-4 md:space-y-6 lg:space-y-8 landscape-mobile:space-y-0 transition-all duration-300 ease-in-out">
          ...
          <div className="flex flex-col space-y-3 sm:space-y-4 md:space-y-6 lg:space-y-0 landscape-mobile:space-y-2 transition-all duration-300 ease-in-out">
            <div className="border-l-4 border-secondary pl-4 landscape-mobile:pl-2">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl landscape-mobile:text-lg font-bold leading-tight font-primary uppercase transition-all duration-300 ease-in-out">
                Our Next <span className="text-secondary">Expedition</span>
              </h1>
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl landscape-mobile:text-lg font-bold md:whitespace-nowrap landscape-mobile:whitespace-normal font-primary uppercase transition-all duration-300 ease-in-out">
                Brings a{" "}
                <span className="text-bright-ocean-blue">New Website</span>{" "}
                Ashore
              </h1>
              <p className="text-xs md:text-base lg:text-lg landscape-mobile:text-[10px] font-medium mt-8 landscape-mobile:mt-3 font-body md:whitespace-nowrap landscape-mobile:whitespace-normal transition-all duration-300 ease-in-out">
                We're building a new online home for CeyFish Company.
              </p>
              <p className="text-xs md:text-base lg:text-lg landscape-mobile:text-[10px] font-medium mb-2 landscape-mobile:mb-1 font-body md:whitespace-nowrap landscape-mobile:whitespace-normal transition-all duration-300 ease-in-out">
            ...
            {/* Contact Section */}
            <div className="mt-10 landscape-mobile:mt-3 text-center lg:text-start landscape-mobile:text-start md:ml-14 landscape-mobile:ml-2 font-body uppercase font-semibold transition-all duration-300 ease-in-out">
              <p className="text-bright-ocean-blue text-xs md:text-lg lg:text-2xl landscape-mobile:text-[11px] transition-all duration-300 ease-in-out">
                Questions or orders ?
              </p>
              <p className="text-xs md:text-lg lg:text-2xl landscape-mobile:text-[11px] whitespace-nowrap landscape-mobile:whitespace-normal transition-all duration-300 ease-in-out">
                Get in touch with us today !
              </p>
            </div>

            {/* Contact Buttons */}
            <div className="flex justify-center lg:justify-start landscape-mobile:justify-start gap-4 landscape-mobile:gap-2 mt-6 lg:mt-24 landscape-mobile:mt-2 md:ml-14 landscape-mobile:ml-2 font-body transition-all duration-300 ease-in-out">
              <a
          ...
          <div className="flex flex-col items-center justify-center w-full gap-y-5 sm:gap-y-10 md:gap-y-0 landscape-mobile:gap-y-2 transition-all duration-300 ease-in-out">
            ...
            <div className="text-[8px] md:text-xs lg:text-sm landscape-mobile:text-[7px] space-y-2 md:space-y-4 landscape-mobile:space-y-1 text-center font-body font-medium max-w-[90%] transition-all duration-300 ease-in-out">

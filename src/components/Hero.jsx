...
export default function Hero() {
  return (
    <div className="relative min-h-screen w-full flex flex-col justify-center">
      ...
      {/* Body */}
      <main className="flex flex-col lg:flex-row items-center justify-start w-full mx-auto px-4 gap-10 mt-24 flex-grow z-10">
        {/* Left Section */}
        <div className="text-white lg:w-2/3">
          ...
          <div className="flex justify-center lg:justify-start gap-2 sm:gap-4 mt-6 lg:mt-24 md:ml-14 font-body">
            <a href="tel:+14378789393"
              ...
              className="btn-hero w-20 md:w-33 flex-row items-center justify-center bg-secondary hover:border-btn-dark">
            ...
            <a
              ...
              className="btn-hero w-21 md:w-33 flex-row items-center justify-center bg-secondary hover:border-btn-dark">
